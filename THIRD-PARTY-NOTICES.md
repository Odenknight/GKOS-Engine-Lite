...
by this tool, not the architectural foundation upon which GKX or this tool is
built. No claim that this project predates or has priority over Google Cloud's
OKF specification is made or implied.
...
Apache-2.0. Dependencies and third-party materials retain their original
licenses and notices. See `LICENSE` and `ACKNOWLEDGMENTS.md`.
